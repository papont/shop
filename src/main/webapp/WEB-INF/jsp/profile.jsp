        ...
        <div class="shadow">
            ...
            <div class="view-box">
                <form:form modelAttribute="userTo" class="form-horizontal" method="post"
                    ...
                    <shop:inputField label="Name" name="name"/>
                    <shop:inputField label="Email" name="email"/>
                    <shop:inputField label="Password" name="password" inputType="password"/>
                    <%--<shop:inputField label="Calories per day" name="caloriesPerDay"/>--%>
